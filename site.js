const translations = {
  zh: {
    ...
    "hero.brand": "<strong>SleeePal 睡眠宝</strong>：蓝牙先试用建立信任，有线再追求更低延迟与更强的枕边效果。",
    "hero.primary": "查看公开进展",
    ...
    "hero.wave.resultValue": "主峰 −18 dB · 改善 68%",
    "hero.stat.freq": "主频",
    "hero.stat.cancel": "理论降噪",
    ...
    "science.title": "主动降噪，<br/><em>从耳道放大到枕边</em>",
    "science.desc": "Bose 发明了主动降噪耳机，把安静送进了耳道。<br/>SleeePal 把同样的物理原理带到你的枕边目标近场；当前首发重点是用 <strong>Mac + 外接音箱</strong> 持续验证更可信的效果链路。",
    ...
    "science.list3": "<strong>手机 / Mac + 有线音箱</strong> — 更低延迟、更低辐射，床头场景效果更稳定，是当前推荐升级路径",
    ...
    "slogan.body": "首个版本不靠夸张承诺取胜，而是把本地监测、场景引导、三轨可视化、夜报与升级路径做扎实。先让你愿意每天打开，再逐步把床头效果做强。",
    ...
    "visual.track3.meta2": "改善约 68%",
    "visual.disclaimer": "⚠ 理论效果为信号模拟估算，实际效果受空间、设备类型及摆位距离影响",
    "visual.badge": "守护中 · 宁静",
    "testimony.kicker": "真实反馈",
    "testimony.title": "<em>她们睡得更好了</em>",
    "testimony.1.body": "以前每天晚上都要硬塞耳塞，侧睡压着很不舒服。现在就把手机放枕边，打开 SleeePal，真的能感觉到那个频率的声音被“平掉”了。我终于愿意直接躺下了。",
    "testimony.1.footer": "— 王女士，32岁，北京",
    "testimony.2.body": "宝宝夜里特别容易被外面声音吵醒，用了之后明显少了好几次。我自己也跟着多睡了将近一个小时。早上起来精神好太多了——那种感觉，是任何护肤品都给不了的。",
    "testimony.2.footer": "— 陈妈妈，29岁，上海",
    "testimony.3.body": "午睡 20 分钟对我太重要了，以前公司太吵根本睡不着。打开 SleeePal 叠一个雨声，那种安静感真的不一样——下午整个人都清醒，比喝咖啡管用。",
    "testimony.3.footer": "— 李同学，24岁，深圳",
  ...
  en: {
    ...
    "hero.brand": "<strong>SleeePal</strong>: start with bluetooth to build trust, then upgrade to wired for lower latency and stronger bedside results.",
    ...
    "hero.proof2Label": "desktop build available now",
    ...
    "hero.wave.resultValue": "main peak −18 dB · 68% improvement",
    "hero.stat.freq": "Peak band",
    "hero.stat.cancel": "Estimated reduction",
    ...
    "science.title": "Active noise control,<br/><em>scaled from the ear canal to the pillow edge</em>",
    "science.desc": "Bose brought active noise control into the ear. SleeePal brings the same physical idea to the near field around your pillow, with the first release focused on validating the more trustworthy <strong>Mac + external speaker</strong> path.",
    ...
    "science.list3": "<strong>Phone / Mac + wired speaker</strong> — lower latency, lower radiation, and more stable bedside results; this is the current recommended upgrade path",
    ...
    "slogan.body": "The first release does not win by overpromising. It wins by making local monitoring, scenario guidance, three-track visuals, reports, and the upgrade path feel solid enough to return to every day.",
    ...
    "visual.track3.meta2": "~68% improvement",
    ...
    "testimony.kicker": "Early reactions",
    "testimony.title": "<em>They slept better</em>",
    "testimony.1.body": "I used to jam in earplugs every night and side-sleeping hurt. Now I just place the phone by the pillow, start SleeePal, and genuinely feel that band of sound flatten out. I finally want to lie down directly.",
    "testimony.1.footer": "— Ms. Wang, 32 · Beijing",
    "testimony.2.body": "Our baby used to wake from the slightest outside sound. With this running, it happened noticeably less often, and I slept almost an hour more myself. That morning feeling is something no skincare product can buy.",
    "testimony.2.footer": "— Chen, mother of one, 29 · Shanghai",
    "testimony.3.body": "A 20-minute nap matters too much to me, but the office used to be too noisy. When I open SleeePal and layer in rain, the calm feels different. I am sharper all afternoon. Better than coffee.",
    "testimony.3.footer": "— Li, 24 · Shenzhen",
